...
export const DISCOVER_SUBGENRES: DiscoverSubgenreMap = {
  MOVIE: {
    ...
    Adventure: [],
    Animation: ["Anime"],
    Comedy: ["Absurdist Comedy","Dark Comedy","Romantic Comedy", "Parody", "Quirky Comedy", "Satire", "Slapstick"],
    Crime: ["Caper", "Gangster", "Police"],
    Documentary: ["Docudrama"],
    Drama: ["Docudrama", "Historical", "Period Drama"],
    Family: [],
    Fantasy: ["High Fantasy", "Superhero", "Sword & Sorcery", "Steampunk", "Urban Fantasy"],
    Horror: ["Body Horror", "Folk Horror", "Found Footage", "Monster Horror", "Psychological Horror", "Slasher"],
    Musical: [],
    Mystery: [],
    Romance: ["Romantic Comedy"],
    "Science Fiction": ["Alternate History", "Cyberpunk", "Dystopian", "Post Apocalyptic", "Space Opera"],
  ...
  TV_SHOW: {
    ...
    Animation: ["Anime"],
    Comedy: ["Absurdist Comedy","Dark Comedy","Romantic Comedy", "Parody", "Quirky Comedy", "Satire", "Slapstick"],
    Crime: ["Caper", "Gangster", "Police", "True Crime"],
 ...
 Romance: ["Romantic Comedy"],
  ...
  VIDEO_GAME: {
    ...
    Shooter: ["First Person Shooter", "Looter", "Tactical Shooter", "Third Person Shooter"],
    Simulation: [],
    Sports: [],
